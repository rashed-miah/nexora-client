...
const InfoCard = ({ icon: Icon, title, description, color }) => (
  <div className="card bg-base-100 shadow-xl hover:shadow-2xl transition duration-300 border border-base-200">
    <div className="card-body items-center text-center">
      ...
      <h2 className="card-title text-lg font-semibold text-[color:var(--color-base-content)]">{title}</h2>
      <p className="text-sm opacity-80 text-[color:var(--color-base-content)]">{description}</p>
    </div>
  </div>
);
